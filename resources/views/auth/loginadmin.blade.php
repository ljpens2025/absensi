...
<link href="{{asset('tabler/css/tabler.css?1768284136')}}" rel="stylesheet" />
<!-- END GLOBAL MANDATORY STYLES -->

<!-- BEGIN PLUGINS STYLES -->
<link href="{{asset('tabler/css/tabler-flags.css?1768284136')}}" rel="stylesheet"/>
<link href="{{asset('tabler/css/tabler-socials.css?1768284136')}}" rel="stylesheet"/>
<link href="{{asset('tabler/css/tabler-payments.css?1768284136')}}" rel="stylesheet"/>
<link href="{{asset('tabler/css/tabler-vendors.css?1768284136')}}" rel="stylesheet"/>
<link href="{{asset('tabler/css/tabler-marketing.css?1768284136')}}" rel="stylesheet"/>
<link href="{{asset('tabler/css/tabler-themes.css?1768284136')}}" rel="stylesheet"/>
<!-- END PLUGINS STYLES -->
<!-- BEGIN DEMO STYLES -->
<link href="{{asset('tabler/css/tabler-socials.css?1768284136')}}" rel="stylesheet"/>
<!-- END DEMO STYLES -->
...
<div class="card card-md">
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1"><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg></a>
