...
<html lang="en">
  <head>
    ...
    <title>
      Sign in - Tabler - Premium and Open Source dashboard template with
    ...
    <link
      href="{{asset('tabler/css/tabler.css?1768284136')}}"
      rel="stylesheet"
    />
    ...
    <link
      href="{{asset('tabler/css/tabler-flags.css?1768284136')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('tabler/css/tabler-socials.css?1768284136')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('tabler/css/tabler-payments.css?1768284136')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('tabler/css/tabler-vendors.css?1768284136')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('tabler/css/tabler-marketing.css?1768284136')}}"
      rel="stylesheet"
    />
    <link
      href="{{asset('tabler/css/tabler-themes.css?1768284136')}}"
      rel="stylesheet"
    />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    ...
    <script
      ...
      src="/.11ty/reload-client.js"
    ></script>
  </head>
  <body>
    <a href="#content" class="visually-hidden skip-link"
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <div class="card card-md">
          <div class="card-body">
            <h2 class="h2 text-center mb-4">Login menggunakan akun admin</h2>
    ...
    <div class="settings">
      ...
      >
        <div class="offcanvas-header">
          <h2 class="offcanvas-title" id="offcanvas-settings-title">
            Theme Settings
          </h2>
          <button
            type="button"
